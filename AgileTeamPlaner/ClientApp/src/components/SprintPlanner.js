        ...
        for (let key in this.state.matrix) {
            ...
            for (let colkey in row.children) {
                ...
                if (Array.isArray(rowContent)) {
                    ...
                    children.push(<Cell key={this.state.sprintName + " " +  row + " " + colkey} cellType={CellTypes.empty} images={row.children[colkey]}></Cell>)
                } else {
                    children.push(<Cell key={this.state.sprintName + " " + row + " " + colkey} cellType={CellTypes.context} context={row.children[colkey]}></Cell>)
                }                
